...
var createElm = (oldParentVNode, newParentVNode, childIndex, parentElm) => {
  ...
  if (BUILD.slotRelocation) {
    if (newVNode2.$flags$ & (2 | 1)) {
      ...
      elm["s-rf"] = (_a2 = newVNode2.$attrs$) === null || _a2 === void 0 ? void 0 : _a2.ref;
    ...
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8) {
          style = await import("./shadow-css-BASWFUPH.js").then((m) => m.scopeCss(style, scopeId2, false));
        }
...
*/
//# sourceMappingURL=chunk-4CCWOWOL.js.map
